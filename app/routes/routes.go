...
func (_ tIssues) Index(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("Issues.Index", args).URL
}
...
func (_ tIssues) New(
	...
	return revel.MainRouter.Reverse("Issues.New", args).URL
}
...
func (_ tIssues) Show(
	...
	revel.Unbind(args, "issueID", issueID)
	return revel.MainRouter.Reverse("Issues.Show", args).URL
}
...
func (_ tIssues) Edit(
	...
	revel.Unbind(args, "issueID", issueID)
	return revel.MainRouter.Reverse("Issues.Edit", args).URL
}

func (_ tIssues) Create(
		title string,
		description string,
		status string,
		priority string,
	...
	revel.Unbind(args, "assigneeID", assigneeID)
	revel.Unbind(args, "reporterID", reporterID)
	revel.Unbind(args, "projectID", projectID)
	revel.Unbind(args, "sprintID", sprintID)
	revel.Unbind(args, "dueDate", dueDate)
	return revel.MainRouter.Reverse("Issues.Create", args).URL
}
...
func (_ tIssues) List(
	...
	return revel.MainRouter.Reverse("Issues.List", args).URL
}
...
func (_ tIssues) View(
	...
	revel.Unbind(args, "issueID", issueID)
	return revel.MainRouter.Reverse("Issues.View", args).URL
}

func (_ tIssues) Update(
		issueID uint,
		title string,
		description string,
		status string,
	...
	revel.Unbind(args, "reporterID", reporterID)
	revel.Unbind(args, "dueDate", dueDate)
	return revel.MainRouter.Reverse("Issues.Update", args).URL
}

func (_ tIssues) Delete(
		issueID uint,
		) string {
	args := make(map[string]string)
	
	revel.Unbind(args, "issueID", issueID)
	return revel.MainRouter.Reverse("Issues.Delete", args).URL
}
